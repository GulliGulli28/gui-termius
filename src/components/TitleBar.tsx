    ...
    <div data-tauri-drag-region className="flex h-9 shrink-0 select-none items-center justify-between border-b border-[var(--c-border)] bg-[var(--c-bg2)] pl-2">
      <div className="flex items-center gap-1">
        <button
          ...
          className="flex h-6 w-7 items-center justify-center rounded text-slate-500 hover:bg-slate-700 hover:text-slate-200"
        >
      ...
      <div className="flex h-full">
        ...
        <button onClick={() => appWindow.toggleMaximize()} aria-label="Agrandir" className="flex h-full w-11 items-center justify-center text-slate-400 hover:bg-slate-800 hover:text-slate-100">
          {isMaximized ? (
            <svg width="10" height="10" viewBox="0 0 10 10">
              <rect x="2.5" y="0.5" width="7" height="7" fill="none" stroke="currentColor" strokeWidth="1" />
              <path d="M0.5 2.5H7.5V9.5H0.5Z" fill="#0f172b" stroke="currentColor" strokeWidth="1" />
            </svg>
          ) : (
            <svg width="10" height="10" viewBox="0 0 10 10">
        ...
        <button onClick={() => appWindow.close()} aria-label="Fermer" className="flex h-full w-11 items-center justify-center text-slate-400 hover:bg-rose-600 hover:text-white">
          <svg width="10" height="10" viewBox="0 0 10 10">
